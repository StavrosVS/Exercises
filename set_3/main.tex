...
%  Rotate 90° counter-clockwise so loop begins at bottom:
\newcommand{\botcircleleft}{\rotatebox[origin=c]{180}{$\circlearrowleft$}}
\newcommand{\botcircleright}{\rotatebox[origin=c]{180}{$\circlearrowright$}}
